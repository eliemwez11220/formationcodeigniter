<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('article/edit/'.$article['article_uid']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="article_image" value="<?php echo ($this->input->post('article_image') ? $this->input->post('article_image') : $article['article_image']); ?>" class="form-control" id="article_image" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="article_date_pub" value="<?php echo ($this->input->post('article_date_pub') ? $this->input->post('article_date_pub') : $article['article_date_pub']); ?>" class="has-datetimepicker form-control" id="article_date_pub" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="article_created_at" class="control-label">Article Created At</label>
						<div class="form-group">
							<input type="text" name="article_created_at" value="<?php echo ($this->input->post('article_created_at') ? $this->input->post('article_created_at') : $article['article_created_at']); ?>" class="has-datetimepicker form-control" id="article_created_at" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="article_updated_at" value="<?php echo ($this->input->post('article_updated_at') ? $this->input->post('article_updated_at') : $article['article_updated_at']); ?>" class="has-datetimepicker form-control" id="article_updated_at" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="article_deleted_at" value="<?php echo ($this->input->post('article_deleted_at') ? $this->input->post('article_deleted_at') : $article['article_deleted_at']); ?>" class="has-datetimepicker form-control" id="article_deleted_at" />
						</div>
					</div>
					<div class="col-md-6">
